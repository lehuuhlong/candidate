                    ...
                    >
                        ...
                        >
                            <Item
                                ...
                                name="title"
                            >
                                <Input size={size} placeholder="Title" />
                            </Item>
                        </Card>
                                    ...
                                    <Col span={8}>
                                        <div style={{ marginRight: "16px" }}>
                                            <Item label="First Name" name="first_name">
                                                <Input placeholder="Enter Name" size={size} />
                                            </Item>
                                            <Item label="Phone" name="phone">
                                                <Input placeholder="Enter Phone" size={size} />
                                            </Item>
                                    ...
                                    <Col span={8}>
                                        <div style={{ marginLeft: "16px" }}>
                                            <Item label="Last Name" name="last_name">
                                                <Input placeholder="Enter Lastname" size={size} />
                                            </Item>
                                            <Item label="Birth Date" name="birth_day">
