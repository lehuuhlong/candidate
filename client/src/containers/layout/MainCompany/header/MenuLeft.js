...
const MenuLeft = () => {
    ...
    return (
        ...
        <Menu mode="horizontal" style={{ background: 'inherit', width: '50%', border: 'none' }}>
            ...
            <Item className="menu-item"><MenuHRCentral title="HR Central" /></Item>
            <Item className="menu-item"><Link to={"/company/job-feed"} style={{ color: "white", fontWeight: "bold" }}>Job Feed</Link></Item>
            <Item className="menu-item"><Link to={`/company/companydetail/${auth.user?._id}`} style={{ color: "white", fontWeight: "bold" }}>Company Info</Link></Item>
